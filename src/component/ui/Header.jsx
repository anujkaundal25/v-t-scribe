      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-6">
            <a
              href={`tel:${headerData.topBar.phone}`}
              className="flex items-center gap-2 hover:text-white transition-colors"
            >
              <FaPhoneAlt className="text-sky-400" />
              <span className="font-medium tracking-wide">
                {headerData.topBar.phone}
              </span>
            </a>
            <a
              href={`mailto:${headerData.topBar.email}`}
              className="flex items-center gap-2 hover:text-white transition-colors"
            >
              ...
              return (
                <Link
                  ...
                  className={`block py-2.5 border-b border-[#013868] text-lg font-semibold transition-colors duration-200 ${
                    isActive
                      ? "text-sky-300 border-sky-400 pl-2"
                      : "text-white hover:text-sky-200 hover:pl-2"
                  }`}
                >
                  {link.label}
                </Link>
